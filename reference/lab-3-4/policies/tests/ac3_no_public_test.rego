...
closed_firewall := {"planned_values": {"root_module": {"resources": [{
	"address": "google_compute_firewall.office_ssh",
	"type": "google_compute_firewall",
	"values": {
		"direction": "INGRESS",
...
test_narrow_source_range_passes if {
	count(ac3.deny) == 0 with input as closed_firewall
}
